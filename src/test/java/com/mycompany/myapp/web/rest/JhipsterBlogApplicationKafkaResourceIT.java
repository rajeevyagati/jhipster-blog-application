...
class JhipsterBlogApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterBlogApplicationKafkaResource kafkaResource = new JhipsterBlogApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-blog-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-blog-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
