...
@RestController
@RequestMapping("/api/jhipster-blog-application-kafka")
public class JhipsterBlogApplicationKafkaResource {
    private final Logger log = LoggerFactory.getLogger(JhipsterBlogApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterBlogApplicationKafkaResource(KafkaProperties kafkaProperties) {
